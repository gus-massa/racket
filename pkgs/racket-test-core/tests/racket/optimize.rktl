...
(parameterize ([current-namespace (make-base-namespace)]
  ...
  (let* ([struct:rock (eval 'struct:rock)]
    ...
    (let ([test-trig
      ...
      (test-trig log 'fllog)
      (test-trig exp 'flexp)
      #;(test-trig sin 'unsafe-flsin)
      #;(test-trig cos 'unsafe-flcos)
      #;(test-trig tan 'unsafe-fltan)
      #;(test-trig asin 'unsafe-flasin)
      #;(test-trig acos 'unsafe-flacos)
      #;(test-trig atan 'unsafe-flatan)
      #;(test-trig log 'unsafe-fllog)
      #;(test-trig exp 'unsafe-flexp)
      )
    ...
    (for-each
     (lambda (v)
       (define (once v)
         ...
         #;(un-exact (round v) 'unsafe-flround v #t)
         #;(un-exact (ceiling v) 'unsafe-flceiling v #t)
         #;(un-exact (floor v) 'unsafe-flfloor v #t)
         #;(un-exact (truncate v) 'unsafe-fltruncate v #t))
       (once v)
       (once (- v)))
    ...
    #;(bin-exact 9.0 'unsafe-flexpt 3.0 2.0 #t)
    #;(bin-exact (expt 3.1 2.5) 'unsafe-flexpt 3.1 2.5 #t)
    #;(bin-exact -1.0 'unsafe-flexpt -1.0 3.0 #t)
    #;(bin-exact -0.125 'unsafe-flexpt -2.0 -3.0 #t)
    #;(bin-exact +nan.0 'unsafe-flexpt -1.0 3.1 #t)
    #;(bin-exact 0.0 'unsafe-flexpt 0.0 10.0 #t)
    #;(bin-exact +inf.0 'unsafe-flexpt 0.0 -1.0 #t)
    #;(bin-exact +1.0 'unsafe-flexpt 0.0 0.0 #t)
    #;(bin-exact +nan.0 'unsafe-flexpt +nan.0 2.7 #t)
    #;(bin-exact +nan.0 'unsafe-flexpt 2.7 +nan.0 #t)
    #;(bin-exact +nan.0 'unsafe-flexpt +nan.0 +nan.0 #t)
