...
# define jit_FPSEL_ceilr_xd_i(use_fpu, rd, rs) (use_fpu ? jit_fpu_ceilr_ld_i(rd, rs) : jit_ceilr_d_i(rd, rs))
# define jit_FPSEL_ceilr_xd_l(use_fpu, rd, rs) (use_fpu ? jit_fpu_ceilr_ld_l(rd, rs) : jit_ceilr_d_l(rd, rs))
# define jit_FPSEL_ceilr_xd_l_fppop(use_fpu, rd, rs) (use_fpu ? jit_fpu_ceilr_ld_l_fppop(rd, rs) : jit_ceilr_d_l_fppop(rd, rs))
# define jit_FPSEL_floorr_xd_i(use_fpu, rd, rs) (use_fpu ? jit_fpu_floorr_ld_i(rd, rs) : jit_floorr_d_i(rd, rs))
# define jit_FPSEL_floorr_xd_l(use_fpu, rd, rs) (use_fpu ? jit_fpu_floorr_ld_l(rd, rs) : jit_floorr_d_l(rd, rs))
# define jit_FPSEL_floorr_xd_l_fppop(use_fpu, rd, rs) (use_fpu ? jit_fpu_floorr_ld_l_fppop(rd, rs) : jit_floorr_d_l_fppop(rd, rs))
